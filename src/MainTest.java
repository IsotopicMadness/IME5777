...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		Triangle tri = new Triangle(t1,t2,t3, new Color(),new Material(1,1,1));
		Plane pl = new Plane(t1, v, new Color(), new Material(1,1,1));
		Sphere sp = new Sphere(t3,5.0,new Color(), new Material(1,1,1));
		Cylinder cyl = new Cylinder(5.0,t2,r,new Color(), new Material(1,1,1));
