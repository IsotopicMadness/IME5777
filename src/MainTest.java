...
public class MainTest {
	...
	public static void main(String[] args) {
		/**
		 * We shall test the primitives package first. The tests will revolve around
		 * actions done on each class and the extreme cases.
		 */
		...
		Vector v = new Vector(new Coordinate(x.add(x.getNum())), new Coordinate(y.add(y.getNum())),
				new Coordinate(z.subtract(y.getNum())));
		 ...
		 */
		Ray r = new Ray(v, new Point3D(new Coordinate(x.subtract(0.99999999999999999999)),
				new Coordinate(y.mult(z.getNum())), new Coordinate(z.mult(-0.5))));

		System.out.println(r.toString());

		/**
		 * Output from the begging until this point: The "add", "Subtract" and
		 * "mult/scale" seems to be working even with extreme cases
		 *
		 * 1.0 2.0 -4.0 0.5 (1.0, 2.0) (-0.4, 5.0) (1.0, 2.0, -4.0) (1.0, 2.0, -4.0)
		 * (2.0, 4.0, -6.0) (34.0, 14.0, 2.0) (368.0, 832.0, -432.0)
		 * (0.36540173102745377, 0.8261256527577217, -0.4289498581626631) (2.0, 4.0,
		 * -6.0) Direction: (2.0, 4.0, -6.0) Location: (0.0, -8.0, 2.0)
		 */
		...
		/**
		 * 
		 * (1.0, 4.0, -9.0) (-1.0, 2.0, 3.0) (7.0, 0.0, 5.0) (1.0, 4.0, -9.0), (-1.0,
		 * 2.0, 3.0), (7.0, 0.0, 5.0) Point: (1.0, 4.0, -9.0), Vector: (2.0, 4.0, -6.0)
		 * Radius: 5.0, Point: (7.0, 0.0, 5.0) Direction and length: (2.0, 4.0, -6.0),
		 * 7.483314773547883 Radius: 5.0 Point: (-1.0, 2.0, 3.0)
		 */
