...
public class Project {
	...
	public void main() {
		...
		_scene.addLightSource(
				new PointLight(new Point3D(-6.39727, 3.38068, -0.951183).add(new Vector(0,0,1).scale(10)), 1, 0, 0, new Color(255, 255, 255), 10));
		_scene.addGeometry(new Plane(new Point3D(0, 8.02304, 0), new Vector(0, -1, 0), new Color(255, 0, 0).scale(0.1),
				new Material(1, 1, 10, 0, 0.7)));
		_scene.addGeometry(new Plane(new Point3D(-10.2914, 0, 0), new Vector(1, 0, 0), new Color(255, 255, 0).scale(0.1),
				new Material(1, 1, 10, 0, 0.7)));
		_scene.addGeometry(new Plane(new Point3D(0, 0, -2.7243), new Vector(0, 0, 1), new Color(255, 0, 255).scale(0.1),
				new Material(1, 1, 10, 0, 0.7)));
		_scene.addGeometry(new Sphere(new Point3D(-6.39727, 3.38068, -0.951183), 3.871,
				new Color(0, 0, 255).scale(0.1), new Material(1, 1, 35, 0.3, 0)));
		_scene.addGeometry(new Sphere(new Point3D(-6.88142, -1.52322, -1.26099), 3.178,
				new Color(0, 255, 255).scale(0.1), new Material(1, 1, 15, 0.3, 0)));
		_scene.addGeometry(new Sphere(new Point3D(-0.98223, 3.60253, -2.38037), 2.669,
				new Color(255, 0, 255).scale(0.1), new Material(1, 0.85, 73, 0.1, 0)));
		...
		_scene.addGeometry(new Sphere(new Point3D(-10.0714, 8.02301, -2.52438), 2.555,
				new Color(255, 0, 255).scale(1), new Material(1, 0.85, 73, 0.1, 0)));
