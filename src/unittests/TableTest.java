...
// the surface
        Triangle triangle1 = new Triangle(new Point3D(-100, 50, -60),
                ...
                new Point3D(200, 50, -60),new Color(0, 0, 255),  new Material(1,1,10,0,0));
...
//the sides of the table
        //the staright side
        Triangle triangle3 = new Triangle(new Point3D(-200, -70, -60),
				new Point3D(-200, -50, -60),
                new Point3D(100, -50, -60));

        Triangle triangle4 = new Triangle(new Point3D(-200, -70, -60),
                new Point3D(100, -70, -60),
                new Point3D(100, -50, -60));
        ...
        //the slant side
        Triangle triangle5 = new Triangle(new Point3D(100, -50, -60),
                new Point3D(100, -70, -60),
                new Point3D(200, 50, -60));

        Triangle triangle6 = new Triangle(new Point3D(200, 30, -60),
                new Point3D(100, -70, -60),
                new Point3D(200, 50, -60));
...
//the legs of the table
        ...
        Triangle triangle7 = new Triangle(new Point3D(80, -70, -60),
                new Point3D(80, -200, -60),
                new Point3D(100, -200, -60));

        Triangle triangle8 = new Triangle(new Point3D(80, -70, -60),
                new Point3D(100, -70, -60),
                new Point3D(100, -200, -60));

        triangle7.setEmmission(new Color(0, 255, 255));
        triangle8.setEmmission(new Color(0, 255, 255));
        Triangle triangle9 = new Triangle(new Point3D(100, -70, -60),
                new Point3D(110, -60, -60),
                new Point3D(100, -200, -60));

        Triangle triangle10 = new Triangle(new Point3D(110, -180, -60),
                new Point3D(110, -60, -60),
                new Point3D(100, -200, -60));
        ...
        //the right slant leg
        Triangle triangle11 = new Triangle(new Point3D(170, -120, -60),
                new Point3D(190, -120, -60),
                new Point3D(170, 0, -60));

        Triangle triangle12 = new Triangle(new Point3D(190, 20, -60),
                new Point3D(190, -120, -60),
                new Point3D(170, 0, -60));

        triangle11.setEmmission(new Color(0, 255, 255));
        triangle12.setEmmission(new Color(0, 255, 255));
        Triangle triangle13 = new Triangle(new Point3D(190, 20, -60),
                new Point3D(200, 30, -60),
                new Point3D(190, -120, -60));

        Triangle triangle14 = new Triangle(new Point3D(200, -100, -60),
                new Point3D(200, 30, -60),
                new Point3D(190, -120, -60));
        ...
        Triangle triangle15 = new Triangle(new Point3D(-200, -70, -60),
                new Point3D(-180, -200, -60),
                new Point3D(-200, -200, -60));

        Triangle triangle16 = new Triangle(new Point3D(-200, -70, -60),
                new Point3D(-180, -200, -60),
                new Point3D(-180, -70, -60));

        triangle15.setEmmission(new Color(0, 255, 255));
        triangle16.setEmmission(new Color(0, 255, 255));
        Triangle triangle17 = new Triangle(new Point3D(-170, -70, -60),
                new Point3D(-180, -70, -60),
                new Point3D(-180, -200, -60));

        Triangle triangle18 = new Triangle(new Point3D(-170, -70, -60),
                new Point3D(-170, -180, -60),
                new Point3D(-180, -200, -60));

        triangle17.setemission(new Color(255, 0, 0));
        ...
        //SpotLight spotLight=new SpotLight(new Color(255, 48, 60), new Point3D(0, 0, -5), new Vector(0, 0, -10),0.001, 0.01, 0.00001);
