...
public class PlaneTest {
	...
	public void testIntersectionPoints(){
		...
		Plane plane = new Plane(new Point3D(0.0, 0.0, -3.0), new Vector(0.0, 0.0, -1.0), new Color(), new Material(1,1,1));
		
		//45 degrees to the view plane
		Plane plane2 = new Plane(new Point3D(0.0, 0.0, -3.0), new Vector(0.0, 0.25, -1.0), new Color(), new Material(1,1,1));
	...
	public void testEqualsObject() {
		...
		Plane p1 = new Plane(new Point3D(0.0, 0.0, -3.0), new Vector(0.0, 0.25, -1.0), new Color(), new Material(1,1,1));
		Plane p2 = new Plane(new Point3D(0.0,0.0,0.0000001),new Vector(0.0,0.25,-0.999999999999), new Color(), new Material(1,1,1));
		Plane p3 = new Plane(new Point3D(1.0, 3.0, -3.0), new Vector(0.0, 0.25, -1.0), new Color(), new Material(1,1,1));
	...
	/*@Test
	public void testPlaneCctr() {
		fail("Not yet implemented");
	}

	@Test
	public void testPlane3Point3D() {
		fail("Not yet implemented");
	}
